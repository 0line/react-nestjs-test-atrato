...
export default function NewUserModal(props) {
  ...
  return (
    <div>
      <Button fullWidth onClick={handleOpen} variant="contained" sx={props.sx} aria-label="add to shopping cart">
      ...
      >
        <Box sx={style}>
          ...
          </Grid>
          {
            ...
            (<div></div>)}        
          <ValidatorForm component="form" id="frmupdate" noValidate autoComplete="off" onSubmit={onSubmit}>
            <Grid container spacing={2} px={4} my={1}>
              <Grid item xs={12} sm={4} my={1}>
                <TextValidator type="text" fullWidth label="nombre" name="firstname" variant="filled" size='normal'
              ...
              <Grid item xs={12} sm={4} my={1}>
                <TextValidator fullWidth label="apellido paterno" variant="filled" size='normal'
              ...
              <Grid item xs={12} sm={4} my={1}>
                <TextValidator fullWidth label="apellido materno" variant="filled"
                 size='normal'
            ...
            <Grid container spacing={2} px={4} my={1}>
              <Grid item xs={12} sm={4} my={1}>
                <TextValidator fullWidth label="email" variant="filled" 
                size='normal'
              ...
              <Grid item xs={12} sm={4} my={1}>
                <TextValidator fullWidth label="telefono" variant="filled" 
                size='normal'
              ...
              <Grid item xs={12} sm={4} my={1}>
                <TextValidator fullWidth label="fecha nacimiento" variant="filled" 
                size='normal'
                type="date"
                InputLabelProps={{
                  shrink: true,
            ...
            <Grid container spacing={2} px={4} my={1}>
              <Grid item xs={12} sm={6} my={1}>
                <TextValidator fullWidth label="analista" variant="filled" 
                size='normal'
